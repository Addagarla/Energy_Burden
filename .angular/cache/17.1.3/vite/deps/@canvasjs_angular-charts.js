  ...
  "node_modules/@canvasjs/charts/canvasjs.min.js"(exports, module) {
    (function() {
      ...
      var hb = function() {
        ...
        return { x: l, y: r2 };
      }, bb = true, Ta = window.devicePixelRatio || 1, Pa = 1, ma = bb ? Ta / Pa : 1, $ = function(h, l, r2, u2, z2, E2, C, K2, M2, Q, Z2, V2, R2) {
      ...
      L.prototype.updateOption = function(h) {
        !qa[this._defaultsKey] && (Ja && window.console) && console.log("defaults not set");
      ...
      E = Ra.Chart = function() {
        ...
        l.prototype._mouseEventHandler = function(a) {
          ...
          if (this.interactivityEnabled) {
            ...
            else if (a.preventManipulation && a.preventManipulation(), a.preventDefault && a.preventDefault(), Ja && window.console && (window.console.log(c + " --> x: " + d.x + "; y:" + d.y), e && window.console.log(a.which), "mouseup" === c && window.console.log("mouseup")), !e) {
...
// node_modules/@canvasjs/angular-charts/fesm2015/angular-charts.js
